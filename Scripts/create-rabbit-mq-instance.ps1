...
docker run -d --name $CONTAINER_NAME -p 5672:5672 -p 15672:15672 -e RABBITMQ_DEFAULT_USER=$RABBITMQ_USER -e RABBITMQ_DEFAULT_PASS=$RABBITMQ_PASSWORD --network $NETWORK_NAME rabbitmq:management
